...
public class FormCTDNBLL {
    ...
    public ArrayList<Mat_hangMD> getDanhSachMatHangCty(String... statements){
        String[] newStatements = util.themStringVaoArray("MaDonNhap="+maDNChon, statements);
    ...
    public ArrayList<ChitietdonnhapMD> getDanhSachTTSP(String... statements){
        String[] newStatements = util.themStringVaoArray("MaDonNhap="+maDNChon, statements);
        return ctdnDAL.getTable(newStatements);
    }
    ...
    public String taoMaMatHangMoi(){
        ...
        String maMHMoi = "MH_"+maDNChon.split("Cty_")[1]+"_"+df.format(+1);
        return maMHMoi;
    }
    public void themMatHangMoi(Mat_hangMD mhMoi){
        matHangDAL.addOne(mhMoi);
    }
    public String getMaDNChon(){
        return this.maDNChon;
    }
}